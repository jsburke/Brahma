...
typedef float data_t; // change me below on type change!! SUPER IMPORTANT
...
typedef enum octype {ROOT, LVL_1, LVL_2} octype;  //  LVL_2 has no octant children, but uses body arrays
