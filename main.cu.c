...
__global__ void kernel_forceCalc(data_t * d_mass, data_t * d_pos_x, data_t * d_pos_y, data_t * d_pos_z, data_t * d_vel_x, data_t * d_vel_y, data_t * d_vel_z, data_t * d_fma_x, data_t * d_fma_y, data_t * d_fma_z) {
